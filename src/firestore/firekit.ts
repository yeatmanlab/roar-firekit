...
import { getTaskAndVariant, getTasks, getTasksVariants } from './query-assessment';
...
export class RoarFirekit {
  ...
  async getTasksVariants(requireRegistered = true) {
    this._verifyAuthentication();
    return getTasksVariants(this.app!.db, requireRegistered);
  }
}
